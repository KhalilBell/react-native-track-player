...
public class DefaultAudioItem: AudioItem {
	...
	public init(audioUrl: String, volume: Double, artist: String? = nil, title: String? = nil, albumTitle: String? = nil, sourceType: SourceType, artwork: UIImage? = nil) {
...
public class DefaultAudioItemTimePitching: DefaultAudioItem, TimePitching {
	...
	public override init(audioUrl: String, volume: Double, artist: String?, title: String?, albumTitle: String?, sourceType: SourceType, artwork: UIImage?) {
        self.pitchAlgorithmType = AVAudioTimePitchAlgorithm.lowQualityZeroLatency
		super.init(audioUrl: audioUrl, volume: volume ,artist: artist, title: title, albumTitle: albumTitle, sourceType: sourceType, artwork: artwork)
    }
    
	public init(audioUrl: String, volume: Double, artist: String?, title: String?, albumTitle: String?, sourceType: SourceType, artwork: UIImage?, audioTimePitchAlgorithm: AVAudioTimePitchAlgorithm) {
...
public class DefaultAudioItemInitialTime: DefaultAudioItem, InitialTiming {
	...
	public init(audioUrl: String, volume: Double, artist: String?, title: String?, albumTitle: String?, sourceType: SourceType, artwork: UIImage?, initialTime: TimeInterval) {
...
public class DefaultAudioItemAssetOptionsProviding: DefaultAudioItem, AssetOptionsProviding {
    ...
    public init(audioUrl: String, volume: Double, artist: String?, title: String?, albumTitle: String?, sourceType: SourceType, artwork: UIImage?, options: [String: Any]) {
